function [local_optimum_molecule_allocated, local_optimum] = train_data_set_prepare(num, node, r, n, NA, T, tau, diffusion_coefficient, distance_low_bound, distance_upper_bound, molecule_low_bound, molecule_upper_bound)
%   此处显示详细说明
% NA : 发送节点释放的分子个数
...
fprintf(1, '\n############ distance:[%d, %d] ############\n',rand_distance(1), rand_distance(2));
%% Experiment
% 实验参数准备
