...
[tx_node, rx_node, env_params, sim_params] = prepare_vars4_diffusion_runners_PointSrc(dist_inMicroMeters, emission_pt, receiver_pt, 4, 50, 0, 0, delta_t, num_molecules_to_emit, ts, 0.001, [0.5 0.5], nsym, 1000);
% Run 
